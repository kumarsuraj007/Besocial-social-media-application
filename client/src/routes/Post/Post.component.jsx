...
const Post = () => {
  ...
  return (
    <div className='flex flex-col md:w-[120vh] w-[50vh] mx-auto shadow-md mt-5 h-[550px]'>
      ...
      <input className="outline-none w-[302px] ps-2" type="text" placeholder='Title' onChange={(e) => setTitle(e.target.value)} />
      <input className="outline-none w-[302px] ps-2" type="text" placeholder='Body' onChange={(e) => setBody(e.target.value)} />
      <label
